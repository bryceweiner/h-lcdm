# H-ΛCDM ML Pipeline Docker Image
# =================================
#
# Builds the analysis framework with ML pipeline support, including
# PyTorch, CUDA dependencies (if available), and ML-specific libraries.
...
HEALTHCHECK --interval=30s --timeout=10s --start-period=5s --retries=3 \
    CMD python -c "import torch; import numpy; print('H-ΛCDM ML environment ready')" || exit 1
